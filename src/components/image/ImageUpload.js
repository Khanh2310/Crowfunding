...
const ImageUpload = ({ onChange = () => {}, name = "" }) => {
  ...
  return (
    <label className=" w-full border border-gray-500 border-dashed h-[200px] rounded-xl cursor-pointer flex items-center justify-center">
      <input className="hidden" type="file" onChange={hanleUpLoadImage} />
      <svg
